...
- **Web Development** — Frontend- und Backend-Entwicklung
- **Vue.js** — JavaScript-Framework für moderne UIs
- **Python** — Backend, Automation, Datenverarbeitung
...
- **Unterrichtsrolle** — Ich unterrichte Anwendungsentwickler:innen
- **Fokus** — Vorbereitung auf KI-gestützte Softwareentwicklung
- **Ziel** — Meine Schüler:innen befähigen, mit modernen KI-Tools verantwortungsvoll zu arbeiten
